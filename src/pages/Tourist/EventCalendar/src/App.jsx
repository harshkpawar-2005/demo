      ...
      <div id="main" data-scroll-container ref={containerRef}>
        ...
        <div id="page2" className="season-page">
          ...
          <div className="festivals-container">
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/sahrul.jpg')" }}><h2>Sahrul</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/sahrul.mp4" loop muted></video></div><div className="info-container"><h3>The Festival of Sahrul</h3><p>Sahrul is a major spring festival celebrated by tribal communities in Jharkhand, symbolizing new beginnings and the worship of nature.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/baha.jpg')" }}><h2>Baha Parab</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/baha.mp4" loop muted></video></div><div className="info-container"><h3>Baha Parab</h3><p>Baha Parab is a flower festival celebrated by various tribal groups in Jharkhand, especially the Santhals, to welcome spring.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/holi.jpg')" }}><h2>Holi</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/holi.mp4" loop muted></video></div><div className="info-container"><h3>The Festival of Colors</h3><p>Holi celebrates the arrival of spring and the victory of good over evil.</p><button className="explore-btn">Explore</button></div></div></div>
          </div>
        </div>
        <div className="empty"></div>
        <div id="page3" className="season-page">
          ...
          <div className="cursor-text">Click to see festivals</div>
          <div className="festivals-container">
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/karam.jpg')" }}><h2>Karam Parab</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/karam.mp4" loop muted></video></div><div className="info-container"><h3>Karam Parab</h3><p>Karam Parab is an important harvest festival celebrated in Jharkhand, dedicated to the Karam tree, which symbolizes fertility and prosperity.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/jitiya.jpg')" }}><h2>Jitiya</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/jitiya.mp4" loop muted></video></div><div className="info-container"><h3>Jitiya Festival</h3><p>Jitiya is a significant festival where mothers fast for the well-being and longevity of their children.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/nawakhani.jpg')" }}><h2>Nawakhani</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/nawakhani.mp4" loop muted></video></div><div className="info-container"><h3>Nawakhani</h3><p>Nawakhani is a harvest festival where new grains are offered to deities, signifying the fresh produce of the season.</p><button className="explore-btn">Explore</button></div></div></div>
          </div>
        </div>
        <div className="empty"></div>
        <div id="page4" className="season-page">
          ...
          <div className="cursor-text">Click to see festivals</div>
          <div className="festivals-container">
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/durga.jpg')" }}><h2>Durga Puja</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/durga.mp4" loop muted></video></div><div className="info-container"><h3>Durga Puja</h3><p>Durga Puja is a grand festival celebrating the Hindu goddess Durga and her victory over the demon Mahishasura.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/tusu.jpg')" }}><h2>Tusu</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/tusu.mp4" loop muted></video></div><div className="info-container"><h3>Tusu Festival</h3><p>Tusu is a folk festival primarily celebrated by women and girls, particularly known for its vibrant celebrations and songs.</p><button className="explore-btn">Explore</button></div></div></div>
            <div className="festival-card" style={{ backgroundImage: "url('/assets/images/sohrai.jpg')" }}><h2>Sohrai</h2><div className="festival-details"><div className="video-container"><video src="/assets/video/sohrai.mp4" loop muted></video></div><div className="info-container"><h3>Sohrai Festival</h3><p>Sohrai is a harvest festival, often coinciding with Diwali, where cattle are honored and traditional art forms are displayed.</p><button className="explore-btn">Explore</button></div></div></div>
          </div>
        </div>
      </div>
    </>
