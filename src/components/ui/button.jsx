  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ocean: "gradient-ocean text-white hover:opacity-90 shadow-soft hover:shadow-glow",
        sunset: "gradient-sunset text-white hover:opacity-90 shadow-soft hover:shadow-glow",
        nature: "gradient-nature text-white hover:opacity-90 shadow-soft hover:shadow-glow",
        hero: "gradient-hero text-white hover:opacity-90 shadow-soft hover:shadow-glow animate-bounce-in",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft",
        glass: "bg-white/10 text-white border border-white/20 hover:bg-white/20 backdrop-blur-sm shadow-soft",
      },
      size: {
